...
class MyLineReg():    
    def __init__(self, 
        ...
        self.l1_coef = l1_coef    # [0, 1]
        self.l2_coef = l2_coef    # [0, 1]
    ...
    def fit(self, X_input, y_input, verbose=False):
        ...
        for i in range(1, self.n_iter + 1):
            ...
            if self.reg:
                ...
                reg, grad_reg = reg_function(self.weights, [self.l1_coef, self.l2_coef])
            ...
            grad_MSE = 2 / n * np.matmul((y_pred - y).T, X)  # (1, N_features+1)
